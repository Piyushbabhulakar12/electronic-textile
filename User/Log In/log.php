        ...
        <div class="row">
          <div class="col-md-12">
            <div style="background: #fff;">
              <div class="row">
                <div class="col-xl-7">
          <img src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/cd9fd879179927.5cbb4c5a02215.jpg" class="img">
        </div>
        <div class="col-md-5">
          ...
          <div class="container">
             <div class="row">
               <div class="col-xl-9 m-auto">
                  ...
                  Admin Login ? <a href="../../Admin/Log_a/log.php">Log In</a></h6><br>
...
if (isset($_POST['submit'])) 
{
	...
	$pass = md5($pass);
     ...
     $saql = " select * from regi where email = '$email' and pass = '$pass' ";
