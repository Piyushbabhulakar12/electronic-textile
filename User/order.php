...
?>
		...
		<?php
         ...
         $sql = " select * from u_order where u_id = '$id' ";
		...
		?>
						...
						<div class="col-8">
							<h6 style="white-space: nowrap; width: 100%; overflow: hidden; text-overflow: ellipsis; margin-top: 15px;"><a href="v_order.php?id=<?php echo $row['id']; ?>&o_id=<?php echo $row['order_id']; ?>" style="font-size: 16px; color: black; text-decoration: none; "><?php echo $rar['p_name']; ?></a></h6>

							<h6 class="text_p">Brand - <?php echo $rar['p_brand']; ?></h6>
							<h6 class="text_p">Price - <?php echo $rar['p_price']; ?></h6>
                            <h6 class="text_p">QTY - <?php echo $row['p_qty']; ?></h6>
                           <h6 class="text_p">Order - 
                            ...
                            <?php
                             ...
                             {
                             	?>
                              <span style="color: #1ED069;"><?php echo $row['action']; ?></span>
                             	<?php
                             }
