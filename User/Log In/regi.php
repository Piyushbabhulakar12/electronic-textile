        ...
        <div class="row">
          <div class="col-md-12">
            <div style="background: #fff;">
              <div class="row">
                <div class="col-xl-7">
          <img src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/9814fe79176619.5cbb31d232a25.jpg" class="img">
        </div>
        <div class="col-md-5">
...
if (isset($_POST['submit'])) 
{
  ...
  $sql = " insert into regi (f_name,l_name,email,phone,pass,cpass) value ('$f_name','$l_name','$email','$phone','$pass','$cpass') ";
