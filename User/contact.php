          ...
          <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <input type="text" name="u_name" placeholder="Enter Name" class="form-control rounded-0">
              </div>
            </div>
            ...
            <div class="row mt-2">
              <div class="col-md-9">
                ...
                <textarea cols="25" rows="5" name="des" placeholder="Enter Description" class="form-control"></textarea>
              </div>
            </div>
            ...
            <div class="row mt-3">
              <div class="col-md-9">
                 <input type="submit" name="submit" value="Send" class="btn btn-primary rounded-0 w-100">
              </div>
            </div>
...
<br>
          ...
          <div class="col-md-6">
            <img src="https://mir-s3-cdn-cf.behance.net/project_modules/fs/92300589743861.5dfed126a1763.jpg" style="width: 100%; height: 100%; object-fit: cover;">
          </div>
           </div>
        </div>
      </div>
...
if (isset($_POST['submit'])) 
{
  ...
  $sql = " insert into contact (u_name,email,des) values ('$u_name','$email','$des') ";
