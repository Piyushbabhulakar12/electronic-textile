  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption d-none d-md-block">
       ...
       <a href="p_detail.php?id=16"><button class="btn btn-primary mt-1">Shop Now</button></a> 
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        ...
        <a href="p_detail.php?id=25"><button class="btn btn-primary mt-1">Shop Now</button></a>
      </div>
    </div>
    <div class="carousel-item">
    ...
    <div class="carousel-item">
     ...
     <div class="carousel-item">
      ...
      <div class="carousel-caption d-none d-md-block">
        ...
        <a href="p_detail.php?id=21"><button class="btn btn-primary mt-1">Shop Now</button>
      </div>
    </div>
  </div>
...
?>
  ...
  <div class="card-body">
    ...
    <div class="float-end">
      <a href="procc.php?id=<?php echo $row['id']; ?>&p_price=<?php echo $row['p_price']; ?>"><input type="button" name="" value="Add To Cart" class="btn btn-primary" style="font-size: 12px;"></a>
    </div>
