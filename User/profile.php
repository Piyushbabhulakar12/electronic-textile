		...
		<div class="col-md-4 m-auto">
			<div style="background: #fff;" class="shadow">
				<div class="container">
                    ...
                    <h6 class="text_p mt-3">Last Name</h6>
                   <input type="text" name="l_name" value="<?php echo $row['l_name']; ?>" class="form-control">
                   <h6 class="text_p mt-3">Email Id</h6>
                   <input type="text" name="email" value="<?php echo $row['email']; ?>" class="form-control">
                   <h6 class="text_p mt-3">Phone Number</h6>
                   <input type="text" name="phone" value="<?php echo $row['phone']; ?>" class="form-control">
                   <input type="submit" name="submit" value="Save" class="btn btn-primary rounded-0 w-100 mt-3">
                   <br><br>
				</div>
			</div>
		</div>
...
if (isset($_POST['submit'])) 
{
	...
	$sql = " update regi set f_name = '$f_name' , l_name = '$l_name' , email = '$email' , phone = '$phone' where id = '$id' ";
