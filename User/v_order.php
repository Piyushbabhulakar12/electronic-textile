...
?>
      ...
      <?php
         ...
         $sql = " select * from u_order where id = '$usi' ";
         ...
         while ($row = mysqli_fetch_array($rub))
         {
            ...
            $coa = " select * from addproduct where id = '$p_id' ";

            $raar = mysqli_query($conn,$coa);
            
            while ($rar = mysqli_fetch_array($raar)) 
            {
      ...
      ?>
              ...
              <div class="col-md-8">
                 <h6>Order Id - #<?php echo $row['order_id']; ?> Order Date - <?php echo $row['date']; ?></h6>
                 <?php echo $rar['p_name']; ?><br>
            Brand -<?php echo $rar['p_brand']; ?><br>
            Price - <?php echo $row['p_price']; ?> QTY - <?php echo $row['p_qty']; ?><br>
                Dilivery Charges - <?php echo $row['diliver_ch']; ?><br>
            Order - <?php echo $row['action']; ?>
              </div>
...
<div class="container mt-4">
   <div class="row">
      <div class="col-md-8 m-auto">
         ...
         $rows = mysqli_fetch_array($rub);

         ?>
<br>
       <h3>Delivery Address</h3>

        <h6 class="mt-3">Name - <?php echo $rows['u_name']; ?></h6>
      <h6>Email - <?php echo $rows['u_email']; ?></h6>
      <h6>Phone Number - <?php echo $rows['u_phone']; ?></h6>
     <h6>Address = <?php echo $rows['u_add']; ?> , <?php echo $rows['u_city']; ?> , <?php echo $rows['u_city']; ?> , <?php echo $rows['u_state']; ?> - <?php echo $rows['u_pin']; ?></h6>
...
<div class="container">
  <center> <h5>Other items in this order</h5></center>
</div>
...
?>
      ...
      <?php
         ...
         $sql = " select * from u_order where order_id = '$o_id' and id != '$usi' ";
...
<center><div class="container mt-5">
   <button onclick="window.print()" class="btn shadow-sm border" style="width: 150px;">Invoice</button>
<a href="order.php"><input type="button" name="" value="Back" class="btn shadow-sm border" style="width: 150px;"></a>
</div></center>
